...
public class TracingLetterView extends View {
    ...
    public TracingLetterView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
     ...
     /*   Drawable shaderDrawable = typedArray.getDrawable(R.styleable.TracingLetterView_shader);
       // assert shaderDrawable != null;
        Bitmap bitmap;
        if (shaderDrawable != null)
            bitmap = ((BitmapDrawable) shaderDrawable).getBitmap();
        else
            bitmap = getBitmapByAssetName("red.png");
       ...
       // processingPaint.setStrokeWidth(60f);
       // processingPaint.setStrokeMiter(10);
        ...
        //  processingPaint.setShader(shader);
        processingPaint.setColor(Color.parseColor("#D81B60"));
    ...
    public void setLetterChar(@LetterFactory.Letter String letterChar) {
    ...
    protected void onDraw(Canvas canvas) {
       ...
       // canvas.drawPoints(pathPoints, processingPaint);
        // draw anchor
        scaleRect.set(
    ...
    public void inValidate() {
        ...
        if (letterBitmap != null && !letterBitmap.isRecycled()) {
